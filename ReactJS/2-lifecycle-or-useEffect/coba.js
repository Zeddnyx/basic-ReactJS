...
function App() {
  ...
  React.useEffect(function () {
    ...
    console.log(document.querySelector('#btn')); // destroy init carousel
  ...
  }, "Tambah"), /*#__PURE__*/React.createElement("h4", null, "nilai anda : ", count));
}

;
root.render( /*#__PURE__*/React.createElement(App, null)); // jika App di eksekusi makan useEffect akan di render
